/*
This is the VERSION 2 code for the second activity / the activity the user sees after one of the teams reach 5 points
New features include being able to call or text your friend to tell them what happened (or to say hi... :) )
and being able to find volleyball courts near you so you can either go play it yourself or watch a game!
 */
